...
public class MG1Level2Data : MiniGame1LevelData
{
    private void OnEnable()
    {
        ...
        {
            new PanelSolution {panelID = 0, correctAngle = SolarPanel.PanelAngle.Angle60, correctOrientation = SolarPanel.PanelOrientation.West},
            ...
            new PanelSolution {panelID = 3, correctAngle = SolarPanel.PanelAngle.Angle45, correctOrientation = SolarPanel.PanelOrientation.West},
            ...
            new PanelSolution {panelID = 5, correctAngle = SolarPanel.PanelAngle.Angle60, correctOrientation = SolarPanel.PanelOrientation.East},
            new PanelSolution {panelID = 6, correctAngle = SolarPanel.PanelAngle.Angle60, correctOrientation = SolarPanel.PanelOrientation.West},
            new PanelSolution {panelID = 7, correctAngle = SolarPanel.PanelAngle.Angle45, correctOrientation = SolarPanel.PanelOrientation.North},
            new PanelSolution {panelID = 8, correctAngle = SolarPanel.PanelAngle.Angle60, correctOrientation = SolarPanel.PanelOrientation.East}
