...
public class MG1Level0Data : MiniGame1LevelData
{
	private void OnEnable()
	{
		...
		availableAngles = new SolarPanel.PanelAngle[] { SolarPanel.PanelAngle.Angle0, SolarPanel.PanelAngle.Angle45, SolarPanel.PanelAngle.Angle90};
		...
		{
			new PanelSolution {panelID = 0, correctAngle = SolarPanel.PanelAngle.Angle45, correctOrientation = SolarPanel.PanelOrientation.South},
